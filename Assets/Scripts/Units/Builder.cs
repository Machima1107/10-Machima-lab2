...
public class Builder : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        switch (unit.State)
        {
            case UnitState.MoveToBuild:
                MoveToBuild(InProgressBuilding); break;
    ...
    public void CreateBuildingSite(Vector3 pos) //Set a building site
    {
        ...
        GameObject buildingObj = Instantiate(newBuilding, new Vector3(pos.x, newBuilding.transform.position.y, pos.z), Quaternion.identity);
